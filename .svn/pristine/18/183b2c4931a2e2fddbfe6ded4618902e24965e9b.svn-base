...
public class SectionAdapter extends BaseSectionQuickAdapter<MallData, SectionAdapter.MovieViewHolder>
        implements View.OnClickListener {
    private int sdvWidth = DraweeViewUtils.IMG_SIZE_PRODUCT, sdvHeight = DraweeViewUtils
            .IMG_SIZE_PRODUCT;

    public SectionAdapter(int layoutResId, int sectionHeadResId, List<MallData> data) {
    ...
    public void setData(List<RxProduct> beanList) {
        ...
        floowerCount++;
        if (floowerCount > Config.RECOMMENDTOP) {
            floowerCount = 0;
        }

 ...
 */
public class BEmotiomFragment extends BaseFragment {
    ...
    private void initEmotion() {
        ...
        EmotionPagerAdapter emotionPagerRvAdapter = new EmotionPagerAdapter(emotionViews);
        vp.setAdapter(emotionPagerRvAdapter);
     ...
     * 创建显示表情的GridView
     */
    private RecyclerView createEmotionGridView(List<String> emotionNames, int gvWidth, int padding, int itemWidth, int
            gvHeight) {
        // 创建GridView
        RecyclerView rv = new RecyclerView(getActivity());

        rv.setLayoutManager(new GridLayoutManager(getActivity(), 4, GridLayoutManager.VERTICAL, false));

...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SuspensionDecoration setLeftPadding(int leftPadding){
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft()+leftPadding, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        c.drawText(tag, child.getPaddingLeft()+leftPadding,
